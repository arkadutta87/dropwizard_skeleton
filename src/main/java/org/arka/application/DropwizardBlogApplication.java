...
import org.arka.configuration.DropwizardBlogConfiguration;
import org.arka.healthcheck.DropwizardBlogApplicationHealthCheck;
import org.arka.routes.PartsController;
...
public class DropwizardBlogApplication extends Application<DropwizardBlogConfiguration> {
  ...
  public void run(DropwizardBlogConfiguration configuration, Environment environment) {
    ...
    // Register resources
    environment.jersey().register(new PartsController(dbi.onDemand(PartsService.class)));
  }
}
